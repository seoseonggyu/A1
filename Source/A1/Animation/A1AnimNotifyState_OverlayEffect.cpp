// #include "A1AnimNotifyState_OverlayEffect.h"
//
...
//
// #include UE_INLINE_GENERATED_CPP_BY_NAME(A1AnimNotifyState_OverlayEffect)
//
// UA1AnimNotifyState_OverlayEffect::UA1AnimNotifyState_OverlayEffect(const FObjectInitializer& ObjectInitializer)
...
// }
//
// void UA1AnimNotifyState_OverlayEffect::NotifyTick(USkeletalMeshComponent* MeshComponent, UAnimSequenceBase* Animation, float FrameDeltaTime, const FAnimNotifyEventReference& EventReference)
// {
...
// }
//
// void UA1AnimNotifyState_OverlayEffect::NotifyEnd(USkeletalMeshComponent* MeshComponent, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
// {
// 	if (FOverlayEffectProgressInfo* ProgressInfo = ProgressInfoMap.Find(MeshComponent))
// 	{
...
// }
//
// void UA1AnimNotifyState_OverlayEffect::ApplyAllWeaponMeshComponents(FOverlayEffectProgressInfo& ProgressInfo, USkeletalMeshComponent* MeshComponent)
// {
// 	if (ALyraCharacter* LyraCharacter = Cast<ALyraCharacter>(MeshComponent->GetOwner()))
// 	{
// 		if (UA1EquipManagerComponent* EquipManager = LyraCharacter->FindComponentByClass<UA1EquipManagerComponent>())
// 		{
// 			TArray<AA1EquipmentBase*> WeaponActors;
// 			EquipManager->GetAllEquippedActors(WeaponActors);
//
// 			for (AA1EquipmentBase* WeaponActor : WeaponActors)
// 			{
// 				USkeletalMeshComponent* WeaponMeshComponent = WeaponActor->MeshComponent;
// 				WeaponMeshComponent->SetOverlayMaterial(ProgressInfo.OverlayMaterialInstance);
// 				ProgressInfo.MeshComponents.Add(WeaponMeshComponent);
...
// }
//
// void UA1AnimNotifyState_OverlayEffect::ApplyCharacterMeshComponents(FOverlayEffectProgressInfo& ProgressInfo, USkeletalMeshComponent* MeshComponent)
// {
// 	if (ALyraCharacter* LyraCharacter = Cast<ALyraCharacter>(MeshComponent->GetOwner()))
// 	{
